...
$validarEspacioN=substr($nombre,0,1);
  ...
  {
    echo '<script src = "../Assets/js/datosEN.js"> </script>';
    return false;
  }
$validarEspacioA=substr($apellido,0,1);
  if($validarEspacioA===$espacio)
  {
    echo '<script src = "../Assets/js/datosEA.js"> </script>';
    return false;
  }
  if (strlen($nombre)<3)
  {
    echo '<script src = "../Assets/js/datosMN.js"> </script>';
    return false;
  }
  if (strlen($apellido)<3)
  {
    echo '<script src = "../Assets/js/datosMA.js"> </script>';
    return false;
  }
  if (strlen($telefono)<10)
  {
    echo '<script src = "../Assets/js/datosMT.js"> </script>';
    return false;
  }
  if (strlen($contraseña)<3)
  {
    echo '<script src = "../Assets/js/datosMCon.js"> </script>';
    return false;
  }
for ($i=0; $i<strlen($nombre); $i++)
{
  ...
  {
    echo '<script src = "../Assets/js/datosIN.js"> </script>';
    return false;
  }
}
 for ($i=0; $i<strlen($apellido); $i++)
  {
    ...
    {
        echo '<script src = "../Assets/js/datosIA.js"> </script>';
      return false;
    }
  }
